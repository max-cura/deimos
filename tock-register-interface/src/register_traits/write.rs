...
use crate::{
    ArrayDataType, DataType, LocalRegisterCopy, Register, RegisterLongName, ScalarDataType,
};
...
pub trait Write: Register {
    ...
    fn write_field(&self, field: FieldValue<<Self::DataType as DataType>::Value, Self::LongName>)
    where
        Self::DataType: ScalarDataType,
    {
    ...
    fn modify_no_read(
        &self,
        original: LocalRegisterCopy<<Self::DataType as DataType>::Value, Self::LongName>,
        field: FieldValue<<Self::DataType as DataType>::Value, Self::LongName>,
    ) where
        Self::DataType: ScalarDataType,
    {
